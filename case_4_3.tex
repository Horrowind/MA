  ...
  \begin{tikzsubfigure}{}{}{1}
    \begin{scope}[scale=0.7]
     ...
     % \draw (2.5, 3) -- (1, 4.5);
      ...
      \node[anchor=120] at (2, 1) {$i'_0$};
      \node[anchor=180] at (2,2) {$i'_1$};
      \node[anchor=180] at (2,4) {$o_{10}$};
      \node[anchor=180] at (2.5, 3) {$i_{2}'=o_{11}$};
      \node[anchor=-150] at (1, 4.5) {$o_9$};
      \node[anchor=-150] at (1, 5.5) {$\mathbf{o_8}$};
      \node[anchor=-110] at (0, 6.5) {$o_7$};
      \node[anchor=-70] at (-1, 6.5) {$o_6$};
      \node[anchor=-20] at (-2, 5.5) {$o_5$};
      \node[anchor=  0] at (-2, 4.5) {$o_4$};
      \node[anchor=  0] at (-1.5, 3.5) {$o_3$};
      \node[anchor=20] at (-2,2.5) {$o_{2}$};
      \node[anchor=45] at (-1, 2) {$o_{1}$};
      \node[anchor= 30] at (-1, 1) {$i_2=o_{0}$};
