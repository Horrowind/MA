...
\begin{frame}[fragile]{Genaue Problemstellung}
  Wir wollen {\sc Eberhard}-typ Probleme für Sequenzen $q$ mit zwei teilerfremden Einträgen und Sequenzen $w$ mit genau einem Eintrag auf orientierbaren kompakten $2$-Mannigfaltigkeiten eingehend betrachten:
  \begin{block}{}
    \begin{align*}
...
\begin{frame}{4. Beweisschritt}
  ...
  \begin{lemma}
    Sei $\mathcal{M}$ der Patch aus der vorangegangen Konstruktion, so dass zusätzlich alle Flächen in den vier Kopien entlang jeder Kante gutartig zusammenstoßen. Dann ist die aus der Konstruktion erhaltene Karte polyedrisch.
  \end{lemma}
