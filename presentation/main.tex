...
\begin{frame}[fragile]{2. Beweisschritt}{}
  ...
  \end{example}
  \pause
  Solche Konstruktionen sind inspiriert von den platonischen Körpern, es gibt sie für vier der fünf Fälle. Damit ``reduziert'' sich der Gesamtaufwand auf 14 Unterfälle.
\end{frame}
...
\begin{frame}{4. Beweisschritt}
  ...
  Diese Schritte sind nun in allen $14$ Fällen zu tun.
\end{frame}
