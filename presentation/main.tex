  ...
  \begin{columns}
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
        ...
        \medskip
        \uncover<7->{\item Inhalt der Arbeit ist es ähnliche Theoreme sowohl für andere Richtungen und auch für Graphen auf Mannigfaltigkeiten zu zeigen\\ (für den Vortrag beschränken wir uns jedoch weiterhin auf $3$-Polytope, der Unterschied tritt nur in Detailfragen auf)}
        \medskip
...
\begin{frame}[fragile]{2. Beweisschritt}{}
  \begin{itemize}
    ...
    \item durch geschicktes anordnen der Polygone lassen sich aus zwei $l$-gonalen Flächen zwei $l + s$-gonale konstruieren:
  \end{itemize}
  \begin{example}
...
\begin{frame}[fragile]{3. Beweisschritt}
  ...
  \pause
  Im nächsten Schritt ersetzen wir alle überschüssigen Sechs- oder Vierecke durch einen eigenen Patch $\mathcal{P}$, welcher ebenfalls nur aus $s$- und $l$-gonalen Flächen und $r$-valenten Ecken besteht, und erhalten eine Karte mit gewünschtem $p$- und $v$-Vektoren.
\end{frame}
...
\begin{frame}
  \begin{tabularx}{\textwidth}{|c|c|X|}
    ...
    $(4, 3)$ & $l \equiv 1~(\mod 2)$ & Für alle $p, v$ möglich\\
    $(4, 3)$ & $l \equiv 2~(\mod 4)$ & \only<1-5>{Für fast alle $p, v$ möglich} \only<6>{Immer möglich, außer für bestimmte Beispiele}\\
...
\begin{frame}{Offene Fragen}
  \begin{itemize}
    \item Welche $(p, v)$ sind nicht $q$-$w$-realisierbar für $s | l$?\\
      ...
      \pause
    \item Welche $(p, v)$ lassen sich $[q_3 \times 3, q_l \times l]$-$[3]$-realisieren? Diese Frage ist sehr schwierig für $l \geq 13$, wie sieht die Antwort für $l = 11$ oder $l = 12$ aus?
      \pause
