...
\tikzset{
   ...
   lsquare/.style={        decoration={markings, mark=at position 0.5 with {\arrow{open square  }}}, postaction={decorate}},
  ldiamond/.style={        decoration={markings, mark=at position 0.5 with {\arrow{open diamond }}}, postaction={decorate}}
}
