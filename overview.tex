...
\begin{theorem}[{\sc Eberhard}s theorem for $3$-valent polyhedra] Let $(p_k)_{k \geq 3, k \neq 6}$ be a sequence of natural numbers, where $p_k = 0$ for all $k \geq K$ for which
\begin{align*}
...
\end{theorem}
\begin{theorem}[{\sc Eberhard}s theorem for $4$-valent polyhedra] Let $(p_k)_{k \geq 3, k \neq 4}$ be a sequence of natural numbers, where $p_k = 0$ for all $k \geq K$ for which
\begin{align*}
